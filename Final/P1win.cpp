...
void P1win::initialise()
{
    p1_font_texture_id = Utility::load_texture("assets/font1.png");
    GLuint map_texture_id = Utility::load_texture(PLATFORM_FILEPATH);
    m_game_state.map = new Map(21, 17, p1_DATA, map_texture_id, 1, 7, 6);
...
void P1win::render(ShaderProgram* g_shader_program)
{
    m_game_state.map->render(g_shader_program);
    Utility::draw_text(g_shader_program, p1_font_texture_id, "PLAYER 1 WINS!!!", 0.3f, 0.0f, glm::vec3(13.5f, -2.5f, 0.0f));
    
    Utility::draw_text(g_shader_program, p1_font_texture_id, "press Q to quit", 0.3f, 0.0f, glm::vec3(13.75f, -3.75f, 0.0f));
    //Utility::draw_text(g_shader_program, p1_font_texture_id, "HEREEEEEEEEEEEEEEEEEEEEEEeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", 1.3f, 0.0f, glm::vec3(-1.5f, -1.75f, 0.0f));
